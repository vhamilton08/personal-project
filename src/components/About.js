        ...
        <div>
            ...
            <h1>1</h1>
                    ...
                    <div className="card-back">
                        ...
                        <h1>NO MONEY</h1>
                        <p>I got the worst grade on my business plan for a college class. The professor said a chicken finger restaurant would never work. The banks said the same.</p>
                    </div>
                    </div>
                </div>
                <div className="card">
                    ...
                    <div className="card-back">
                        ...
                        <h1>OIL REFINERY</h1>
                        <p>I took a job as a boilermaker working 90 hour weeks in the L.A. refinery to raise my own money.</p>
                    </div>
                    </div>
                </div>
                <div className="card">
                    ...
                    <div className="card-back">
                        ...
                        <h1>ALASKA</h1>
                        <p>Then I fished commercially for Sockeye Salmon in Alaska, working 20 hour days in the dangerous conditions.</p>
                    </div>
                    </div>
                </div>
                <div className="card">
                    ...
                    <div className="card-back">
                        ...
                        <h1>HOME AGAIN</h1>
                        <p>When I returned, I had the money I earned, and was able to get a SBA loan. Just enough to start the first restaurant.</p>
                    </div>
                    </div>
                </div>
                <div className="card">
                ...
                <div className="card">
                    ...
                    <div className="card-back">
                        ...
                        <h1>FIRST DAY</h1>
                        <p>The first Raising Cane’s® opened in 1996. We were so busy, we stayed open ‘til 3:30 a.m. It was great to work with such a fun, dedicated crew!</p>
                    </div>
                    </div>
                </div>
                <div className="card">
